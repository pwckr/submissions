...
# Change the working directory to a new directory (replace with the path you want)S

new_working_directory = "/Users/pwecker/dev/BHT_advanced_software_engineering_WiSe23_Paul_Wecker/Lec2_ Deep Q-Learning/0_Exercise_env/"
